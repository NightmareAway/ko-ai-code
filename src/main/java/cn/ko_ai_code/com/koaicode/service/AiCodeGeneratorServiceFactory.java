...
import cn.ko_ai_code.com.koaicode.config.ReasoningStreamingChatModelConfig;
...
import static cn.ko_ai_code.com.koaicode.model.enums.CodeGenTypeEnum.*;
...
public class AiCodeGeneratorServiceFactory {
    ...
    private final Cache<String, AiCodeGeneratorService> serviceCache = Caffeine.newBuilder()
            ...
            .removalListener((key, value, cause) -> {
                log.debug("AI 服务实例被移除，键: {}, 原因: {}", key, cause);
            })
            .build();
